...
public class MazePanel extends JPanel
{
	...
	private final static Color[] robotsColors = new Color[] { Color.black, Color.blue, Color.cyan, Color.green, Color.magenta, Color.orange, Color.pink, Color.red, Color.yellow };

	private final static double MAZE_SIZE = 500.0;
	private final static double START_MAZE_COORDINATE = 50.0;

	private final static double ROBOT_HALF_DIAMETER = 8;
	...
	// // getVisionXCoordinate(agent.getX(),agent.getAlpha(), vision.getAngle(),
	// vision.getDistance()),
	// // getVisionYCoordinate(agent.getY(),agent.getAlpha(), vision.getAngle(),
	// vision.getDistance())));
	// // }
	//
	// g2.setColor(Color.blue);
	// Ellipse2D.Double ellipse = new Ellipse2D.Double(x - 3.5, y - 3.5, 7.0,
	// 7.0);
	// g2.draw(ellipse);
	// g2.fill(ellipse);
	// g2.draw(new Line2D.Double(x, y, getVisionXCoordinate(agent.getX(),
	// agent.getAlpha(), 0, 0.1),
